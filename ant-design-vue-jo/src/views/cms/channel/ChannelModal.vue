  ...
  <a-modal
    ...
    <a-spin :spinning="confirmLoading">
      <a-form-model ref="form" :model="model" :rules="validatorRules">
        ...
        <a-form-model-item label="栏目名称" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="name">
          <a-input v-model="model.name" placeholder="请输入栏目名称"></a-input>
        </a-form-model-item>
      </a-form-model>
    </a-spin>
  </a-modal>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/cms/channel/add",
          edit: "/cms/channel/edit",
          checkCode:"/cms/channel/checkCode",
        },
        expandedRowKeys:[],
        pidField:"pid",
        subExpandedKeys:[]
