<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <!-- <a-button type="primary" icon="download" @click="handleExportXls('栏目字典')">导出</a-button>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/cms/channel/list",
          childList: "/cms/channel/list",
          getChildListBatch: "/cms/channel/getChildListBatch",
          delete: "/cms/channel/delete",
          deleteBatch: "/cms/channel/deleteBatch",
          sortNo: "/cms/channel/sortNo",
        },
        expandedRowKeys:[],
    ...
    methods: {
      ...
      handleAddSub(record){
        ...
        this.$refs.modalForm.title = "添加子栏目";
        this.$refs.modalForm.edit({'pid':record.id,level:parseInt(record.level)+1 });
