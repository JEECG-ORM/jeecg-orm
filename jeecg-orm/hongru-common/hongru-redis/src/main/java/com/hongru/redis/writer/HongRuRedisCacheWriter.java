package com.hongru.redis.writer;
 ...
 */
@Slf4j
public class HongRuRedisCacheWriter implements RedisCacheWriter {

    private final RedisConnectionFactory connectionFactory;
    private final Duration sleepTime;

    public HongRuRedisCacheWriter(RedisConnectionFactory connectionFactory) {
        this(connectionFactory, Duration.ZERO);
    }

    public HongRuRedisCacheWriter(RedisConnectionFactory connectionFactory, Duration sleepTime) {
