package com.hongru.config.shiro;
...
import com.hongru.util.SpringContextUtils;
...
public class ShiroRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken auth) throws AuthenticationException {
        ...
        if ("UmsMember".equals(loginType)) {
            loginUser.setId(JwtUtil.getUsername(token));
            ...
            if (!jwtTokenRefresh(token, username, username)) {
    ...
    public LoginUser checkUserTokenIsEffect(String token) throws AuthenticationException {
        ...
        LoginUser loginUser = sysUserApi.getUserByName(username);
        if (loginUser == null) {
       ...
       /* if(StringUtils.isNotEmpty(userTenantIds)){
            String contextTenantId = TenantContext.getTenant();
            if(StringUtils.isNotEmpty(contextTenantId) && !"0".equals(contextTenantId)){
