...
import com.hongru.config.shiro.filters.JwtFilter;
import com.hongru.constant.CommonConstant;
import com.hongru.config.shiro.filters.CustomShiroFilterFactoryBean;
...
public class ShiroConfig {
    ...
    @Value("${hongru.shiro.excludeUrls}")
    ...
    public IRedisManager redisManager() {
        ...
        if (lettuceConnectionFactory.getClusterConfiguration() == null || lettuceConnectionFactory.getClusterConfiguration().getClusterNodes().isEmpty()) {
            ...
            if (org.apache.commons.lang.StringUtils.isNotEmpty(lettuceConnectionFactory.getPassword())) {
